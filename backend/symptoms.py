"""Symptom catalog — mirrors src/convex/ml/catalog.ts in the frontend app.

The 32 supported symptom features grouped into clinical categories. This list
must stay in sync with the dataset columns (dataset/disease_symptoms.csv).
"""
